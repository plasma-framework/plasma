...
public class TableImpl extends CoreDataObject implements Serializable, Table {
  ...
  public void setConstraint(Constraint[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetConstraint() method to remove this property");
  }
  ...
  public TableColumnComment[] getTableColumnComment() {
    List<TableColumnComment> list = (List<TableColumnComment>) super
        .get(Table.PROPERTY.tableColumnComment.name());
    if (list != null) {
  ...
  public void setTableColumnComment(TableColumnComment[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetTableColumnComment() method to remove this property");
  }
  ...
  public void setTableComment(TableComment[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetTableComment() method to remove this property");
  }
