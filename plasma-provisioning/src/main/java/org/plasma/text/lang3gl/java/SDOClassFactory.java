...
public class SDOClassFactory extends SDODefaultFactory implements ClassFactory {
  ...
  private void createUnsetter(Package pkg, Class clss, Property field, MetaClassInfo typeClassName,
      TextBuilder buf) {
  ...
  private void createIsSet(Package pkg, Class clss, Property field, MetaClassInfo typeClassName,
      TextBuilder buf) {
  ...
  private void createCreator(Package pkg, Class clss, Property field, MetaClassInfo typeClassName,
      TextBuilder buf) {
  ...
  private void createManyGetter(Package pkg, Class clss, Property field,
      MetaClassInfo typeClassName, TextBuilder buf) {
    buf.appendln(1, "@SuppressWarnings(\"unchecked\")"); // for cast from
                                                         // DataObject[] to
                                                         // specific array
  ...
  private void createManySetter(Package pkg, Class clss, Property field,
    ...
    buf.append(LINE_SEP);
    buf.append(indent(1));
    buf.append("@SuppressWarnings(\"unchecked\")"); // for cast from
                                                    // DataObject[] to specific
                                                    // array
  ...
  private void createManySetterBody(Package pkg, Class clss, Property field,
    ...
    buf.appendln(3, "List<");
    buf.append(typeClassName.getCollectionSimpleName());
    buf.append("> list = new ArrayList<>(value.length);");
    ...
    buf.appendln(
        3,
        "throw new IllegalArgumentException(\"expected non-null and non-zero length array argument 'value' - use unset");
  ...
  public String createDirectoryName(Package pkg) {
    ...
    String subpackage = PlasmaRuntime.getInstance().getSDO().getGlobalProvisioning()
