...
public class ProfileVersionFinder {
  ...
  public ProfileArtifactAdapter getVersion(String artifactURN, InputStream stream) {
    ...
    if (this.result == null) {
      ...
      throw new ProfileVersionDetectionException(
          "no profile version detected for artifact '"
              + artifactURN
              + "' - all UML artifacts are required to be annotated with one of the following versions "
