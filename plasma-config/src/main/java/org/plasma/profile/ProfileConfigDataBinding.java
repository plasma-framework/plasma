...
public class ProfileConfigDataBinding implements DataBinding {
  ...
  public static Class<?>[] FACTORIES = { org.plasma.profile.ObjectFactory.class, };

  @SuppressWarnings("unused")
  private ProfileConfigDataBinding() {
  }

  public ProfileConfigDataBinding(BindingValidationEventHandler validationEventHandler)
