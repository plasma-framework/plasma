...
/**
 * This interface represents a helper execution context. The set of helpers
 * returned by the methods in this interface have visibility to the same SDO
 * metadata, that is, they execute in the same "scope".
 */
