...
public interface XMLHelper {
  /**
   * Creates and returns an XMLDocument from the input String. By default does
   * not perform XSD validation. Same as load(new StringReader(inputString),
   * null, null);
   * 
   * @param inputString
   ...
   *          specifies the InputStream to read from
   * @param locationURI
   *          specifies the URI of the document for relative schema locations
   * @param options
  ...
  /**
   * Creates and returns an XMLDocument from the inputReader. The InputStream
   * will be closed after reading. By default does not perform XSD validation.
   * 
   * @param inputReader
   *          specifies the Reader to read from
   * @param locationURI
   *          specifies the URI of the document for relative schema locations
   * @param options
   *          implementation-specific options.
  ...
  /**
   * Creates and returns an XMLDocument from the inputSource. The InputSource
   * will be closed after reading. By default does not perform XSD validation.
   * 
   * @param inputSource
   *          specifies the Source to read from
   * @param locationURI
   *          specifies the URI of the document for relative schema locations
   * @param options
   *          implementation-specific options.
   ...
   * element. Same as StringWriter stringWriter = new StringWriter();
   * save(createDocument(dataObject, rootElementURI, rootElementName),
   * stringWriter, null); stringWriter.toString();
   *
   * @param dataObject
   *          specifies DataObject to be saved
   * @param rootElementURI
   *          the Target Namespace URI of the root XML element
   ...
   * Same as save(createDocument(dataObject, rootElementURI, rootElementName),
   * outputStream, null);
   * 
   * @param dataObject
   *          specifies DataObject to be saved
   ...
   *           if the dataObject tree is not closed or has no container.
   */
  void save(DataObject dataObject, String rootElementURI, String rootElementName,
      OutputStream outputStream) throws IOException;

  /**
   * Serializes an XMLDocument as an XML document into the outputStream. If the
   * DataObject's Type was defined by an XSD, the serialization will follow the
   * XSD. Otherwise the serialization will follow the format as if an XSD were
   * generated as defined by the SDO specification. The OutputStream will be
   * flushed after writing. Does not perform validation to ensure compliance
   * with an XSD.
   * 
   * @param xmlDocument
   *          specifies XMLDocument to be saved
   * @param outputStream
   *          specifies the OutputStream to write to.
   * @param options
   *          implementation-specific options.
  ...
  /**
   * Serializes an XMLDocument as an XML document into the outputWriter. If the
   * DataObject's Type was defined by an XSD, the serialization will follow the
   * XSD. Otherwise the serialization will follow the format as if an XSD were
   * generated as defined by the SDO specification. The OutputStream will be
   * flushed after writing. Does not perform validation to ensure compliance
   ...
   *          specifies XMLDocument to be saved
   * @param outputWriter
   *          specifies the Writer to write to.
   * @param options
   *          implementation-specific options.
   * @throws IOException
   *           for stream exceptions.
   ...
   * javax.xml.transform). The OutputResult will be flushed after writing. Does
   * not perform validation to ensure compliance with an XSD.
   * 
   * @param xmlDocument
   *          specifies XMLDocument to be saved
   * @param outputResult
   *          specifies Result to be saved
   * @param options
   *          implementation-specific options.
   * @throws IOException
   *           for stream exceptions.
