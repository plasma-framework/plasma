 ...
 * 
 * An example XMLDocument fragment is: <?xml version="1.0"?> <purchaseOrder
 * orderDate="1999-10-20">
 * 
 * created from this XML Schema fragment: <xsd:schema
 * xmlns:xsd="http://www.w3.org/2001/XMLSchema"> <xsd:element
 * name="purchaseOrder" type="PurchaseOrderType"/> <xsd:complexType
...
public interface XMLDocument {
   ...
   * produce a declaration of the form: <?xml version="1.0" encoding="UTF-8"?>
