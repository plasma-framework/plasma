...
/**
 * A representation of the type of a {@link Property property} of a
...
public interface Type {
  ...
  /**
   * Returns the List of base Types for this Type. The List is empty if there
   * are no base Types. XSD <extension>, <restriction>, and Java extends keyword
   * are mapped to this list.
   * 
   ...
   * {@link commonj.sdo.helper.TypeHelper#define(DataObject) defining the Type's
