...
public abstract class DefaultUMLModelAssembler implements UMLModelAssembler {
  ...
  protected DefaultUMLModelAssembler(Query query, String destNamespaceURI,
    ...
    this.document = buildDocumentModel(query, this.destNamespaceURI, this.destNamespacePrefix);
  }
  ...
  protected DefaultUMLModelAssembler(Schema schema, String destNamespaceURI,
    ...
    if (destNamespacePrefix == null || destNamespacePrefix.trim().length() == 0)
      throw new IllegalArgumentException("expected 'destNamespacePrefix' argument");
    this.document = buildDocumentModel(schema, this.destNamespaceURI, this.destNamespacePrefix);
  }
  ...
  private Document buildDocumentModel(Query query, String destNamespaceURI,
      String destNamespacePrefix) {
  ...
  private Element buildClass(Class clss) {
    ...
    /*
     * --e.g. XMI for an external reference <generalization
     * xmi:type='uml:Generalization'
     * xmi:id='_16_0_1_1707042b_1325701279933_851156_1151'> <general
     * xmi:type='uml:Class' href=
     * 'plasma-platform-common.mdxml#_16_0_1_1707042b_1318367153137_813743_576'>
   ...
   * xmi:id='_17_0_6_1707042b_1376433440849_3356_7405' name='create'
   * visibility='public'> <body>FOO BAR;</body> <language>SQL</language>
   * </ownedBehavior>
   * 
   * @param clss
   *          the
