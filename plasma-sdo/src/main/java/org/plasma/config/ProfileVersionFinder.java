...
public class ProfileVersionFinder 
{
    ...
    private ProfileArtifact result;
		 
	public ProfileArtifact getVersion(String artifactURN, InputStream stream) {
		try {
			setup();
		    read(stream);
        	    ...
        	    if (uri != null && uri.trim().length() > 0)
         	    ...
         	    if (isRoot(name)) {         	    	          	    	
         	    	...
         	    	while (iter.hasNext()) {
         	    		...
         	    		ProfileArtifact version = findVersion(value);
         	    		if (version != null) {
         	    			this.result = version;
         	    			this.abort = true;
         	    			break;
	...
	private ProfileArtifact findVersion(String value)
	{
