...
import org.plasma.provisioning.rdb.oracle.g11.sys.query.QViewColumn;
import org.plasma.provisioning.rdb.oracle.g11.sys.query.QViewColumnComment;
import org.plasma.provisioning.rdb.oracle.g11.sys.query.QViewComment;
import org.plasma.provisioning.rdb.oracle.g11.sys.View;

/**
 * Represents a system view definition
 * <p></p>
 * Generated Domain Specific Language (DSL) implementation class representing the domain model entity <b>View</b>.
 *
 * <p></p>
...
public class QView extends DomainRoot
{
	...
	/**
	 * Returns a new DSL query for <a href="http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaType.html">Type</a> <b>View</b> which can be used either as a query root or
	...
	/**
	 * Returns a DSL query element for reference property, <b>viewColumn</b>, while adding the given path predicate expression. 
	...
	/**
	 * Returns a DSL query element for reference property, <b>viewColumnComment</b>.
	 * @return a DSL query element for reference property, <b>viewColumnComment</b>.
	 */
	...
	/**
	 * Returns a DSL query element for reference property, <b>viewColumnComment</b>, while adding the given path predicate expression. 
	 * Path predicate expressions are used to restrict
	 * the query results for a collection property within a <a href="http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaDataGraph.html">DataGraph</a>.
	 * @param expr the path predicate expression
	 * @return a DSL query element for reference property, <b>viewColumnComment</b>.
	...
	/**
	 * Returns a DSL query element for reference property, <b>viewComment</b>, while adding the given path predicate expression. 
	 * Path predicate expressions are used to restrict
	 * the query results for a collection property within a <a href="http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaDataGraph.html">DataGraph</a>.
	 * @param expr the path predicate expression
	 * @return a DSL query element for reference property, <b>viewComment</b>.
