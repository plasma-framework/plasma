 ...
 * <p></p>
 * Generated implementation class representing the domain model entity <b>Column</b>.
 *
 * <p></p>
 ...
 *
 */
public class ColumnImpl extends CoreDataObject implements Serializable, Column
{
	...
	public ColumnImpl(commonj.sdo.Type type) {
		super(type);
	}
	...
	public boolean isSetCharacterSetName(){
		return super.isSet(Column.PROPERTY.characterSetName.name());
	}
	...
	public void unsetCharacterSetName(){
		super.unset(Column.PROPERTY.characterSetName.name());
	}
	...
	public String getCharacterSetName(){
		return (String)super.get(Column.PROPERTY.characterSetName.name());
	}
	...
	public void setCharacterSetName(String value){
		super.set(Column.PROPERTY.characterSetName.name(), value);
	}
	...
	public boolean isSetColumnName(){
		return super.isSet(Column.PROPERTY.columnName.name());
	}
	...
	public void unsetColumnName(){
		super.unset(Column.PROPERTY.columnName.name());
	}
	...
	public String getColumnName(){
		return (String)super.get(Column.PROPERTY.columnName.name());
	}
	...
	public void setColumnName(String value){
		super.set(Column.PROPERTY.columnName.name(), value);
	}
	...
	public boolean isSetColumn_id(){
		return super.isSet(Column.PROPERTY.column_id.name());
	}
	...
	public void unsetColumn_id(){
		super.unset(Column.PROPERTY.column_id.name());
	}
	...
	public int getColumn_id(){
		Integer result = (Integer)super.get(Column.PROPERTY.column_id.name());
		if (result != null)
	...
	public void setColumn_id(int value){
		super.set(Column.PROPERTY.column_id.name(), value);
	}
	...
	public boolean isSetDataDefault(){
		return super.isSet(Column.PROPERTY.dataDefault.name());
	}
	...
	public void unsetDataDefault(){
		super.unset(Column.PROPERTY.dataDefault.name());
	}
	...
	public String getDataDefault(){
		return (String)super.get(Column.PROPERTY.dataDefault.name());
	}
	...
	public void setDataDefault(String value){
		super.set(Column.PROPERTY.dataDefault.name(), value);
	}
	...
	public boolean isSetDataLength(){
		return super.isSet(Column.PROPERTY.dataLength.name());
	}
	...
	public void unsetDataLength(){
		super.unset(Column.PROPERTY.dataLength.name());
	}
	...
	public int getDataLength(){
		Integer result = (Integer)super.get(Column.PROPERTY.dataLength.name());
		if (result != null)
			return result.intValue();
		else return 0;
	}
	...
	public void setDataLength(int value){
		super.set(Column.PROPERTY.dataLength.name(), value);
	}
	...
	public boolean isSetDataPrecision(){
		return super.isSet(Column.PROPERTY.dataPrecision.name());
	}
	...
	public void unsetDataPrecision(){
		super.unset(Column.PROPERTY.dataPrecision.name());
	}
	...
	public int getDataPrecision(){
		Integer result = (Integer)super.get(Column.PROPERTY.dataPrecision.name());
		if (result != null)
			return result.intValue();
		else return 0;
	}
	...
	public void setDataPrecision(int value){
		super.set(Column.PROPERTY.dataPrecision.name(), value);
	}
	...
	public boolean isSetDataScale(){
		return super.isSet(Column.PROPERTY.dataScale.name());
	}
	...
	public void unsetDataScale(){
		super.unset(Column.PROPERTY.dataScale.name());
	}
	...
	public int getDataScale(){
		Integer result = (Integer)super.get(Column.PROPERTY.dataScale.name());
		if (result != null)
			return result.intValue();
		else return 0;
	}
	...
	public void setDataScale(int value){
		super.set(Column.PROPERTY.dataScale.name(), value);
	}
	...
	public boolean isSetDataType(){
		return super.isSet(Column.PROPERTY.dataType.name());
	}
	...
	public void unsetDataType(){
		super.unset(Column.PROPERTY.dataType.name());
	}
	...
	public String getDataType(){
		return (String)super.get(Column.PROPERTY.dataType.name());
	}
	...
	public void setDataType(String value){
		super.set(Column.PROPERTY.dataType.name(), value);
	}
	...
	public boolean isSetNullable(){
		return super.isSet(Column.PROPERTY.nullable.name());
	}
	...
	public void unsetNullable(){
		super.unset(Column.PROPERTY.nullable.name());
	}
	...
	public String getNullable(){
		return (String)super.get(Column.PROPERTY.nullable.name());
	}
	...
	public void setNullable(String value){
		super.set(Column.PROPERTY.nullable.name(), value);
	}
	...
	public boolean isSetOwner(){
		return super.isSet(Column.PROPERTY.owner.name());
	}
	...
	public void unsetOwner(){
		super.unset(Column.PROPERTY.owner.name());
	}
	...
	public String getOwner(){
		return (String)super.get(Column.PROPERTY.owner.name());
	}
	...
	public void setOwner(String value){
		super.set(Column.PROPERTY.owner.name(), value);
	}
	...
	public boolean isSetTable(){
		return super.isSet(Column.PROPERTY.table.name());
	}
	...
	public void unsetTable(){
		super.unset(Column.PROPERTY.table.name());
	}
	...
	public Table createTable(){
		return (Table)super.createDataObject(Column.PROPERTY.table.name());
	}
	...
	public Table getTable(){
		return (Table)super.get(Column.PROPERTY.table.name());
	}
	...
	public void setTable(Table value){
		super.set(Column.PROPERTY.table.name(), value);
	}
}