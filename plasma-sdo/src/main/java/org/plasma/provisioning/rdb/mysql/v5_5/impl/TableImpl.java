...
public class TableImpl extends CoreDataObject implements Serializable, Table {
  ...
  public void setTableColumn(TableColumn[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetTableColumn() method to remove this property");
  }
  ...
  public void addTableColumn(TableColumn value) {
    ...
    if (list == null)
      list = new ArrayList<TableColumn>();
    list.add(value);
    // NOTE: SDO 2.1 spec specifies replacing the whole list on a multi-valued
    // 'set' operation
  ...
  public TableColumnConstraint createTableColumnConstraint() {
    return (TableColumnConstraint) super.createDataObject(Table.PROPERTY.tableColumnConstraint
        .name());
  }
  ...
  public TableColumnConstraint[] getTableColumnConstraint() {
    List<TableColumnConstraint> list = (List<TableColumnConstraint>) super
        .get(Table.PROPERTY.tableColumnConstraint.name());
    if (list != null) {
  ...
  public void setTableColumnConstraint(TableColumnConstraint[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetTableColumnConstraint() method to remove this property");
  }
  ...
  public TableColumnKeyUsage[] getTableColumnKeyUsage() {
    List<TableColumnKeyUsage> list = (List<TableColumnKeyUsage>) super
        .get(Table.PROPERTY.tableColumnKeyUsage.name());
    if (list != null) {
  ...
  public void setTableColumnKeyUsage(TableColumnKeyUsage[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetTableColumnKeyUsage() method to remove this property");
  }
  ...
  public TableConstraint[] getTableConstraint() {
    List<TableConstraint> list = (List<TableConstraint>) super.get(Table.PROPERTY.tableConstraint
        .name());
    if (list != null) {
  ...
  public void setTableConstraint(TableConstraint[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetTableConstraint() method to remove this property");
  }
  ...
  public void setView(View[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetView() method to remove this property");
  }
