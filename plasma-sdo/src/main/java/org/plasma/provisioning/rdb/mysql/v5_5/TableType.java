...
public enum TableType implements PlasmaEnum
{
	...
	/**
	 * Holds the logical and physical names for literal <b>SYSTEM_VIEW</b>.
	 */
	SYSTEM_VIEW(null,""),
	
	/**
	 * Holds the logical and physical names for literal <b>BASE_TABLE</b>.
	 */
	BASE_TABLE(null,""),
