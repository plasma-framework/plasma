...
public class ViewImpl extends CoreDataObject implements Serializable, View {
  ...
  public void setViewColumn(ViewColumn[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetViewColumn() method to remove this property");
  }
  ...
  public ViewColumnComment[] getViewColumnComment() {
    List<ViewColumnComment> list = (List<ViewColumnComment>) super
        .get(View.PROPERTY.viewColumnComment.name());
    if (list != null) {
  ...
  public void setViewColumnComment(ViewColumnComment[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetViewColumnComment() method to remove this property");
  }
  ...
  public void setViewComment(ViewComment[] value) {
    ...
    if (value != null && value.length > 0) {
      ...
      throw new IllegalArgumentException(
          "expected non-null and non-zero length array argument 'value' - use unsetViewComment() method to remove this property");
  }
