 ...
 * <p></p>
 * Generated implementation class representing the domain model entity <b>ColumnConstraint</b>.
 *
 * <p></p>
 ...
 *
 */
public class ColumnConstraintImpl extends CoreDataObject implements Serializable, ColumnConstraint
{
	 ...
	 */
	public ColumnConstraintImpl() {
		super();
	}
	public ColumnConstraintImpl(commonj.sdo.Type type) {
		super(type);
	}
	...
	public boolean isSetColumnName(){
		return super.isSet(ColumnConstraint.PROPERTY.columnName.name());
	}
	...
	public void unsetColumnName(){
		super.unset(ColumnConstraint.PROPERTY.columnName.name());
	}
	...
	public String getColumnName(){
		return (String)super.get(ColumnConstraint.PROPERTY.columnName.name());
	}
	...
	public void setColumnName(String value){
		super.set(ColumnConstraint.PROPERTY.columnName.name(), value);
	}
	...
	public boolean isSetConstraintName(){
		return super.isSet(ColumnConstraint.PROPERTY.constraintName.name());
	}
	...
	public void unsetConstraintName(){
		super.unset(ColumnConstraint.PROPERTY.constraintName.name());
	}
	...
	public String getConstraintName(){
		return (String)super.get(ColumnConstraint.PROPERTY.constraintName.name());
	}
	...
	public void setConstraintName(String value){
		super.set(ColumnConstraint.PROPERTY.constraintName.name(), value);
	}
	...
	public boolean isSetOwner(){
		return super.isSet(ColumnConstraint.PROPERTY.owner.name());
	}
	...
	public void unsetOwner(){
		super.unset(ColumnConstraint.PROPERTY.owner.name());
	}
	...
	public String getOwner(){
		return (String)super.get(ColumnConstraint.PROPERTY.owner.name());
	}
	...
	public void setOwner(String value){
		super.set(ColumnConstraint.PROPERTY.owner.name(), value);
	}
	...
	public boolean isSetTable(){
		return super.isSet(ColumnConstraint.PROPERTY.table.name());
	}
	...
	public void unsetTable(){
		super.unset(ColumnConstraint.PROPERTY.table.name());
	}
	...
	public Table createTable(){
		return (Table)super.createDataObject(ColumnConstraint.PROPERTY.table.name());
	}
	...
	public Table getTable(){
		return (Table)super.get(ColumnConstraint.PROPERTY.table.name());
	}
	...
	public void setTable(Table value){
		super.set(ColumnConstraint.PROPERTY.table.name(), value);
	}
}