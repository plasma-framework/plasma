 ...
 * <b>TableColumnKeyUsage</b>. This <a href="http://plasma-sdo.org">SDO</a>
 ...
 * <b>http://org.plasma/sdo/mysql/5_5</b> defined within the <a href=
...
public interface TableColumnKeyUsage extends PlasmaDataObject {
  ...
  public static enum PROPERTY {
     ...
     * </p>
     * <b>Data Store Mapping:</b> Corresponds to the physical data store element
     * <b>KEY_COLUMN_USAGE.CONSTRAINT_NAME</b>.
     */
    name,
     ...
     * </p>
     * <b>Data Store Mapping:</b> Corresponds to the physical data store element
     * <b>KEY_COLUMN_USAGE.COLUMN_NAME</b>.
     */
    columnName,
     ...
     * Represents the logical <a href=
     * "http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaProperty.html"
     * >Property</a> <b>referencedTableSchema</b> which is part of the <a
     * href="http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaType.html"
     * >Type</a> <b>TableColumnKeyUsage</b>.
     *
     * <p>
     * </p>
     * <b>Data Store Mapping:</b> Corresponds to the physical data store element
     * <b>KEY_COLUMN_USAGE.REFERENCED_TABLE_SCHEMA</b>.
     */
     ...
     * Represents the logical <a href=
     * "http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaProperty.html"
     * >Property</a> <b>referencedTableName</b> which is part of the <a
     * href="http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaType.html"
     * >Type</a> <b>TableColumnKeyUsage</b>.
     *
     * <p>
     * </p>
     * <b>Data Store Mapping:</b> Corresponds to the physical data store element
     * <b>KEY_COLUMN_USAGE.REFERENCED_TABLE_NAME</b>.
     */
    referencedTableName,
     ...
     * Represents the logical <a href=
     * "http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaProperty.html"
     * >Property</a> <b>referencedColumnName</b> which is part of the <a
     * href="http://docs.plasma-sdo.org/api/org/plasma/sdo/PlasmaType.html"
     * >Type</a> <b>TableColumnKeyUsage</b>.
     *
     * <p>
     * </p>
     * <b>Data Store Mapping:</b> Corresponds to the physical data store element
     * <b>KEY_COLUMN_USAGE.REFERENCED_COLUMN_NAME</b>.
     */
     ...
     * </p>
     * <b>Data Store Mapping:</b> Corresponds to the physical data store element
     * <b>KEY_COLUMN_USAGE.TABLE_NAME</b>.
     */
    table
  }
  ...
  /**
   * Unsets the <b>referencedTableSchema</b> property, the value of the property
   * of the object being set to the property's default value. The property will
   * no longer be considered set.
   */
  ...
  /**
   * Sets the value of the <b>referencedTableSchema</b> property to the given
   * value.
   */
  ...
  /**
   * Unsets the <b>referencedTableName</b> property, the value of the property
   * of the object being set to the property's default value. The property will
   * no longer be considered set.
   */
  ...
  /**
   * Sets the value of the <b>referencedTableName</b> property to the given
   * value.
   */
  ...
  /**
   * Unsets the <b>referencedColumnName</b> property, the value of the property
   * of the object being set to the property's default value. The property will
   * no longer be considered set.
   */
  ...
  /**
   * Sets the value of the <b>referencedColumnName</b> property to the given
   * value.
   */
