 ...
 */
@Deprecated
public class PropertySelectionCollector extends CollectorSupport implements PropertySelection {
   ...
   * 
   * @see
   * org.plasma.query.collector.PropertySelection#getPredicate(commonj.sdo.Property
   * )
   */
  @Override
  ...
  /**
   * Return the specified property names, as well as any path-reference or key
   * properties required for graph structure, as a simple list of logical
   * property name strings mapped to the respective {@link Type} definition
   * 
   ...
   * 
   * @see
   * org.plasma.query.collector.PropertySelection#hasInheritedType(commonj.sdo
   * .Type)
   */
  @Override
   ...
   * 
   * @see
   * org.plasma.query.collector.PropertySelection#hasProperty(commonj.sdo.Type,
   ...
   * 
   * @see
   * org.plasma.query.collector.PropertySelection#addProperty(commonj.sdo.Type,
   * commonj.sdo.Property)
   */
  @Override
  ...
  private void collect(AbstractProperty abstractProperty) {
    ...
    if (path == null) {
      ...
      if (!this.isOnlySingularProperties()) {
        collect(path, rootType, path.getPathNodes().get(0), 0, abstractProperty);
      } else {
  ...
  /**
   * Recursively collects properties from the given path into the given property
   * map including both wildcard paths and properties
   * 
   * @param path
   *          the path
   * @param currType
