 ...
 * Tests for SDO tool
 */
public class SDOToolTest extends PlasmaTest {
    private static Log log = LogFactory.getLog(SDOToolTest.class);
        
    public static Test suite() {
        return PlasmaTestSetup.newTestSetup(SDOToolTest.class);
    }
