...
public enum FunctionName {
  ...
  DAYOFMONTH("dayofmonth"), @XmlEnumValue("dayofweek")
  DAYOFWEEK("dayofweek"), @XmlEnumValue("dayofyear")
  DAYOFYEAR("dayofyear"), @XmlEnumValue("day")
  DAY("day"), @XmlEnumValue("microsecond")
  MICROSECOND("microsecond"), @XmlEnumValue("minute")
  MINUTE("minute"), @XmlEnumValue("month")
  MONTH("month"), @XmlEnumValue("monthname")
  MONTHNAME("monthname"), @XmlEnumValue("week")
