...
public class Property extends AbstractProperty implements StringDataProperty, IntegralDataProperty,
   ...
   * (non-Javadoc)
   * 
   * @see org.plasma.query.model.Property2#between(java.lang.Object,
   * java.lang.Object)
   */
   ...
   * 
   * @see
   * org.plasma.query.model.Property2#setQuery(org.plasma.query.model.Query)
   */
   ...
   * 
   * @see
   * org.plasma.query.model.Property2#setAs(org.plasma.query.model.Projection)
   */
   ...
   * (non-Javadoc)
   * 
   * @see org.plasma.query.model.Property2#setDirection(org.plasma.query.model.
   * SortDirectionValues)
   */
  ...
  /**
   * Returns the path qualified name for this property, i.e. as the final
   * element within its associated path, if a path exists for this property. If
   * no path exists for this property, simply the name of the property is
   * returned.
   * 
